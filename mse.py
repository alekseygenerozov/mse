...
class MSE(object):
    ...
    def init_lib(self):
        ...
        self.lib.get_log_entry_properties.argtypes = (ctypes.c_int,ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int),ctypes.POINTER(ctypes.c_int),\
         ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int),ctypes.POINTER(ctypes.c_int),ctypes.POINTER(ctypes.c_double),ctypes.POINTER(ctypes.c_int),ctypes.POINTER(ctypes.c_int),\
         ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double),ctypes.POINTER(ctypes.c_double),ctypes.POINTER(ctypes.c_double))
    ...
    def __get_log(self):
        ...
        for index_log in range(N_log):
            ...
            N_particles,event_flag,integration_flag,index1,index2,binary_index,kick_speed_km_s,SNe_type,SNe_info,eccentric_collision,eccentricity,kick_vx,kick_vy,kick_vz =\
             ...
             ctypes.c_int(0),ctypes.c_int(0),ctypes.c_double(0.0),ctypes.c_double(0.0),ctypes.c_double(0.0),ctypes.c_double(0.0)
            flag = self.lib.get_log_entry_properties(index_log,ctypes.byref(time),ctypes.byref(event_flag),ctypes.byref(integration_flag),ctypes.byref(N_particles),\
                ctypes.byref(index1),ctypes.byref(index2),ctypes.byref(binary_index),ctypes.byref(kick_speed_km_s),ctypes.byref(SNe_type),ctypes.byref(SNe_info),\
                ctypes.byref(eccentric_collision),ctypes.byref(eccentricity),ctypes.byref(kick_vx),ctypes.byref(kick_vy),ctypes.byref(kick_vz))
            entry.update({'time':time.value,'event_flag':event_flag.value,'integration_flag':integration_flag.value,'index1':index1.value,'index2':index2.value,'binary_index':binary_index.value,'N_particles':N_particles.value,\
                'kick_speed_km_s':kick_speed_km_s.value,"SNe_type":SNe_type.value,"SNe_info":SNe_info.value,"eccentric_collision":eccentric_collision.value,"eccentricity":eccentricity.value,\
                'kick_vx':kick_vx.value,'kick_vy':kick_vy.value,'kick_vz':kick_vz.value})
